...
struct TCheckedPointerIterator
{
    ...
    {
        Ptr = reinterpret_cast<ElementType*>(reinterpret_cast<char*>(Ptr) + GetElementSize<ElementType>());
        return *this;
    }
...
private:
    ...
    FORCEINLINE friend bool operator!=(const TCheckedPointerIterator& Lhs, const TCheckedPointerIterator& Rhs)
    {
        ...
        check(Lhs.CurrentNum == Lhs.InitialNum);
...
public:
    ...
    {
        return AllocatorInstance.GetAllocatedSize(ArrayMax, GetElementSize<ElementType>());
    }
    ...
    FORCEINLINE void RangeCheck(int32 Index) const
    {
        ...
        {
            check((Index >= 0) & (Index < ArrayNum)); // & for one branch
        }
    }
    ...
    {
        RangeCheck(Index);
        return *reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>());
    }
    ...
    {
        RangeCheck(0);
        ElementType Result = MoveTempIfPossible(*reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + (ArrayNum - 1) * GetElementSize<ElementType>()));
    ...
    FORCEINLINE ElementType& Last(int32 IndexFromTheEnd = 0)
    {
        ...
        return *reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + (ArrayNum - IndexFromTheEnd - 1) * GetElementSize<ElementType>());
    }
    ...
    {
        const char* RESTRICT Start = reinterpret_cast<char*>(GetData());
        for (const char* RESTRICT Data = Start, *RESTRICT DataEnd = Data + (ArrayNum * GetElementSize<ElementType>()); Data != DataEnd; Data += GetElementSize<ElementType>())
        {
            if (*reinterpret_cast<ElementType*>(Data) == Item)
            {
                return static_cast<int32>((Data - Start) / GetElementSize<ElementType>());
            }
        }
        return INDEX_NONE;
    }
    ...
    {
        for (const char* RESTRICT Start = reinterpret_cast<char*>(GetData()), *RESTRICT Data = Start + ArrayNum * GetElementSize<ElementType>(); Data != Start; )
        {
            Data -= GetElementSize<ElementType>();
            if (*reinterpret_cast<ElementType*>(Data) == Item)
            {
                return static_cast<int32>((Data - Start) / GetElementSize<ElementType>());
            }
    ...
    int32 FindLastByPredicate(Predicate Pred, int32 Count) const
    {
        ...
        {
            Data -= GetElementSize<ElementType>();
            if (Pred(*reinterpret_cast<ElementType*>(Data)))
            {
                return static_cast<int32>((Data - Start) / GetElementSize<ElementType>());
            }
        }
    ...
    int32 IndexOfByKey(const KeyType& Key) const
    {
        ...
        for (const char* RESTRICT Data = Start, *RESTRICT DataEnd = Data + (ArrayNum * GetElementSize<ElementType>()); Data != DataEnd; Data += GetElementSize<ElementType>())
        {
            if (*reinterpret_cast<ElementType*>(Data) == Key)
            {
                return static_cast<int32>((Data - Start) / GetElementSize<ElementType>());
            }
        }
    ...
    {
        for (const char* RESTRICT Data = reinterpret_cast<char*>(GetData()), *RESTRICT DataEnd = Data + (ArrayNum * GetElementSize<ElementType>()); Data != DataEnd; Data += GetElementSize<ElementType>())
        {
            if (*reinterpret_cast<ElementType*>(Data) == Key)
            {
    ...
    {
        for (char* RESTRICT Data = reinterpret_cast<char*>(GetData()), *RESTRICT DataEnd = Data + (ArrayNum * GetElementSize<ElementType>()); Data != DataEnd; Data += GetElementSize<ElementType>())
        {
            if (Pred(*reinterpret_cast<ElementType*>(Data)))
            {
                return reinterpret_cast<ElementType*>(Data);
    ...
    {
        for (const char* RESTRICT Data = reinterpret_cast<const char*>(GetData()), *RESTRICT DataEnd = Data + (ArrayNum * GetElementSize<ElementType>()); Data != DataEnd; Data += GetElementSize<ElementType>())
        {
            if (*reinterpret_cast<const ElementType*>(Data) == Item)
            {
                return true;
            }
        }
    ...
    void InsertUninitialized(int32 Index, int32 Count = 1)
    {
        ...
        ElementType* Data = reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>());
    ...
    void InsertZeroed(int32 Index, int32 Count = 1)
    {
        ...
        FMemory::Memzero(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>()), Count * GetElementSize<ElementType>());
    }
    ...
    ElementType& InsertZeroed_GetRef(int32 Index)
    {
        ...
        ElementType* Ptr = reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>());
        FMemory::Memzero(Ptr, GetElementSize<ElementType>());
        return *Ptr;
    }
    ...
    {
        InsertUninitialized(Index, Count);
        DefaultConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>()), Count);
    }
    ...
    int32 Insert(std::initializer_list<ElementType> InitList, const int32 InIndex)
    {
        ...
        ConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + InIndex * GetElementSize<ElementType>()), InitList.begin(), NumNewElements);
    ...
    int32 Insert(const TArray<ElementType, OtherAllocator>& Items, const int32 InIndex)
    {
        ...
        InsertUninitialized(InIndex, NumNewElements);
        ConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + InIndex * GetElementSize<ElementType>()), Items.GetData(), NumNewElements);
    ...
    int32 Insert(TArray<ElementType, OtherAllocator>&& Items, const int32 InIndex)
    {
        ...
        InsertUninitialized(InIndex, NumNewElements);
        RelocateConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + InIndex * GetElementSize<ElementType>()), Items.GetData(), NumNewElements);
        Items.ArrayNum = 0;
    ...
    int32 Insert(const ElementType* Ptr, int32 Count, int32 Index)
    {
        ...
        InsertUninitialized(Index, Count);
        ConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>()), Ptr, Count);
     ...
     * @see Add, Remove
     */
    FORCEINLINE void CheckAddress(const ElementType* Addr)
    {
        check(Addr < GetData() || Addr >= (reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + ArrayMax * GetElementSize<ElementType>())));
    }
    ...
    int32 Insert(ElementType&& Item, int32 Index)
    {
        ...
        InsertUninitialized(Index, 1);
        new(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>())) ElementType(MoveTempIfPossible(Item));
        return Index;
    }
    ...
    int32 Insert(const ElementType& Item, int32 Index)
    {
        ...
        // Index, then construct that memory with Item)
        InsertUninitialized(Index, 1);
        new(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>())) ElementType(Item);
        return Index;
    }
...
private:
    void RemoveAtImpl(int32 Index, int32 Count, bool bAllowShrinking)
    {
        if (Count)
        {
            ...
            DestructItems(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>()), Count);
            ...
            if (NumToMove)
            {
                FMemory::Memmove
                (
                    (uint8*)AllocatorInstance.GetAllocation() + (Index)*GetElementSize<ElementType>(),
                    (uint8*)AllocatorInstance.GetAllocation() + (Index + Count) * GetElementSize<ElementType>(),
                    NumToMove * GetElementSize<ElementType>()
                );
            }
            ArrayNum -= Count;
    ...
    void RemoveAtSwapImpl(int32 Index, int32 Count = 1, bool bAllowShrinking = true)
    {
        if (Count)
        {
            ...
            if (NumElementsToMoveIntoHole)
            {
                FMemory::Memcpy(
                    (uint8*)AllocatorInstance.GetAllocation() + (Index)*GetElementSize<ElementType>(),
                    (uint8*)AllocatorInstance.GetAllocation() + (ArrayNum - NumElementsToMoveIntoHole) * GetElementSize<ElementType>(),
                    NumElementsToMoveIntoHole * GetElementSize<ElementType>()
                );
            }
            ArrayNum -= Count;
...
public:
    ...
    void SetNum(int32 NewNum, bool bAllowShrinking = true)
    {
        if (NewNum > Num())
        {
            ...
            DefaultConstructItems<ElementType>((uint8*)AllocatorInstance.GetAllocation() + Index * GetElementSize<ElementType>(), Diff);
        }
        else if (NewNum < Num())
        {
    ...
    void Append(const TArray<OtherElementType, OtherAllocator>& Source)
    {
        ...
        ConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + ArrayNum * GetElementSize<ElementType>()), Source.GetData(), SourceCount);
    ...
    void Append(TArray<OtherElementType, OtherAllocator>&& Source)
    {
        ...
        // Allocate memory for the new elements.
        Reserve(ArrayNum + SourceCount);
        RelocateConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + ArrayNum * GetElementSize<ElementType>()), Source.GetData(), SourceCount);
        Source.ArrayNum = 0;
    ...
    void Append(const ElementType* Ptr, int32 Count)
    {
        ...
        ConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Pos * GetElementSize<ElementType>()), Ptr, Count);
    }
    ...
    FORCEINLINE void Append(std::initializer_list<ElementType> InitList)
    {
        ...
        int32 Pos = AddUninitialized(Count);
        ConstructItems<ElementType>(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Pos * GetElementSize<ElementType>()), InitList.begin(), Count);
    }
    ...
    FORCEINLINE int32 Emplace(ArgsType&&... Args)
    {
        ...
        new(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>())) ElementType(Forward<ArgsType>(Args)...);
        return Index;
    }
    ...
    int32 AddZeroed(int32 Count = 1)
    {
        ...
        FMemory::Memzero((uint8*)AllocatorInstance.GetAllocation() + Index * GetElementSize<ElementType>(), Count * GetElementSize<ElementType>());
        return Index;
    }
    ...
    {
        const int32 Index = AddUninitialized(Count);
        DefaultConstructItems<ElementType>((uint8*)AllocatorInstance.GetAllocation() + Index * GetElementSize<ElementType>(), Count);
        return Index;
    }
...
public:
    ...
    int32 RemoveSingle(const ElementType& Item)
    {
        ...
        auto* RemovePtr = reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + Index * GetElementSize<ElementType>());
    ...
    int32 RemoveAll(const PREDICATE_CLASS& Predicate)
    {
        ...
        int32 WriteIndex = 0;
        int32 ReadIndex = 0;
        bool NotMatch = !Predicate(*reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + ReadIndex * GetElementSize<ElementType>())); // use a ! to guarantee it can't be anything other than zero or one
        do
        {
            int32 RunStartIndex = ReadIndex++;
            while (ReadIndex < OriginalNum && NotMatch == !Predicate(*reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + ReadIndex * GetElementSize<ElementType>())))
            {
                ReadIndex++;
            }
            ...
            if (NotMatch)
            {
                ...
                {
                    FMemory::Memmove(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + WriteIndex * GetElementSize<ElementType>()), reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + RunStartIndex * GetElementSize<ElementType>()), GetElementSize<ElementType>() * RunLength);
                }
            ...
            else
            {
                ...
                DestructItems(reinterpret_cast<ElementType*>(reinterpret_cast<char*>(GetData()) + RunStartIndex * GetElementSize<ElementType>()), RunLength);
            }
            NotMatch = !NotMatch;
    ...
    {
        FMemory::Memswap(
            (uint8*)AllocatorInstance.GetAllocation() + (GetElementSize<ElementType>() * FirstIndexToSwap),
            (uint8*)AllocatorInstance.GetAllocation() + (GetElementSize<ElementType>() * SecondIndexToSwap),
    ...
    {
        class UClass* SearchClass = SearchType::StaticClass();
...
private:
    ...
    FORCEINLINE friend RangedForIteratorType      end(TArray& Array) { return RangedForIteratorType(Array.ArrayNum, reinterpret_cast<ElementType*>(reinterpret_cast<char*>(Array.GetData()) + Array.Num() * GetElementSize<ElementType>())); }
    FORCEINLINE friend RangedForConstIteratorType end(const TArray& Array) { return RangedForConstIteratorType(Array.ArrayNum, reinterpret_cast<ElementType*>(reinterpret_cast<char*>(Array.GetData()) + Array.Num() * GetElementSize<ElementType>())); }
#else
    ...
    FORCEINLINE friend RangedForIteratorType      end(TArray& Array) { return reinterpret_cast<ElementType*>(reinterpret_cast<char*>(Array.GetData()) + Array.Num() * GetElementSize<ElementType>()); }
    FORCEINLINE friend RangedForConstIteratorType end(const TArray& Array) { reinterpret_cast<ElementType*>(reinterpret_cast<char*>(Array.GetData()) + Array.Num() * GetElementSize<ElementType>()); }
#endif
...
private:
    ...
    {
        return *reinterpret_cast<const ElementType*>(reinterpret_cast<const char*>(GetData()) + Index * GetElementSize<ElementType>());
    }
#endif
...
private:
    ...
    {
        ArrayMax = AllocatorInstance.CalculateSlackGrow(ArrayNum, ArrayMax, GetElementSize<ElementType>());
        AllocatorInstance.ResizeAllocation(OldNum, ArrayMax, GetElementSize<ElementType>());
    }
    FORCENOINLINE void ResizeShrink()
    {
        const int32 NewArrayMax = AllocatorInstance.CalculateSlackShrink(ArrayNum, ArrayMax, GetElementSize<ElementType>());
        if (NewArrayMax != ArrayMax)
        {
            ArrayMax = NewArrayMax;
            check(ArrayMax >= ArrayNum);
            AllocatorInstance.ResizeAllocation(ArrayNum, ArrayMax, GetElementSize<ElementType>());
        }
    }
    FORCENOINLINE void ResizeTo(int32 NewMax)
    {
        if (NewMax)
        {
            NewMax = AllocatorInstance.CalculateSlackReserve(NewMax, GetElementSize<ElementType>());
        }
        if (NewMax != ArrayMax)
        {
            ArrayMax = NewMax;
    ...
    FORCENOINLINE void ResizeForCopy(int32 NewMax, int32 PrevMax)
    {
        ...
        if (NewMax != PrevMax)
        {
            AllocatorInstance.ResizeAllocation(0, NewMax, GetElementSize<ElementType>());
        }
        ArrayMax = NewMax;
    }
