...
#pragma message("Detected compiler newer than Visual Studio 2022 Preview, please update min version checking in WindowsPlatformCompilerSetup.h")
#endif
...
#pragma warning(disable: 4244) // 'conversion' conversion from 'type1' to 'type2', possible loss of data							https://docs.microsoft.com/en-us/cpp/error-messages/compiler-warnings/compiler-warning-level-3-c4244
